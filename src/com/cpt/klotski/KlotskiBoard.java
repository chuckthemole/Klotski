...
public class KlotskiBoard extends Klotski {    
    ...
    private KlotskiBlock mouseBlockPane;
    ...
    KlotskiBoard() {
        ...
        //block mouse pane
        mouseBlockPane = new KlotskiBlock("blockMouse", 0, 0, 10);
    ...
    public void setMouse() {
    	...
    	int i;
        for (i = 9; i >= 0; i--) {
            mouse[i] = new MouseDrag(blocks[i], this, mouseBlockPane); 
        }  
    }
    
    public KlotskiBlock getMouseBlockPane() {
    	return mouseBlockPane;
    }
